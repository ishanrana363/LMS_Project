                ...
                <div className="col-md-7 col-lg-6 ">
                    <div style={{boxShadow:" 0 4px 8px rgba(0, 0, 0, 0.2)"}} className="card w-90 p-4">
                        <div className="card-body">
                            ...
                            <label className={"animated fadeInLeft mt-1 "} htmlFor={"password"}>Enter your password : </label> <br/>
                            ...
                            <div className={"float-right mt-4 "}>
                                ...
                                <Link className={"mx-5 animated fadeInRight "} to={"/forget-password"}>Forget Password</Link>
                            </div>
                            <div className={"account mt-3 "} >
                                <span className={"float-left"} >
                                    <p>Don't have an account?<Link className={"mx-1"} to={"/registration"}>Sign up</Link></p>
